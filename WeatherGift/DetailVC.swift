...
extension DetailVC: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus){
        ...
        case .denied:
            showAlertToPrivacySettings(title: "User has not authorized location services", message: "Select 'Settings'below to open the device settings and enable location services")
        case .restricted:
            showAlert(title: "Location services denied", message: "Check parental controls")
        }
    }
